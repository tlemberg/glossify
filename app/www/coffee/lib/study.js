...
(function() {
  define(['utils', 'stack', 'storage', 'nav', 'deck', 'css', 'pageview'], function(utils, stack, storage, nav, deck, css, pageview) {
    var CARD_ASPECT, MAX_CARD_WIDTH, _card, _deck, _getTxSummary, _hideFlipButton, _isFlipped, _loadPage, _nav, _preloadPage, _refreshContentPane, _refreshPage, _resetCard, _setBottomText, _setHeaderCss, _setProgressCounter, _setStudyFooterCss, _setStudyFooterHtml, _setTopText, _showFlipButton;
    _nav = void 0;
    _isFlipped = false;
    _card = void 0;
    _deck = void 0;
    ...
    _refreshPage = function() {
      ...
      return $('.study-content').css('border-color', BG_COLORS[_card['progress']]);
    };
