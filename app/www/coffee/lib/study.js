...
(function() {
  define(['utils', 'nav', 'deck', 'css'], function(utils, nav, deck, css) {
    var BG_COLORS, _card, _deck, _getFooterHeight, _getTxSummary, _hideFlipButton, _isFlipped, _loadPage, _nav, _preloadPage, _refreshContentPane, _refreshPage, _setBottomText, _setHeaderCss, _setProgressCounter, _setStudyFooterCss, _setStudyFooterHtml, _setTopText, _showFlipButton;
    _nav = void 0;
    _isFlipped = false;
    _card = void 0;
    _deck = void 0;
    ...
    _preloadPage = function() {
      ...
      return $('#study-back-btn').click(function(event) {
        return api.updateUserPofile(_userProfile, function(json) {
          if (!json['success']) {
            console.log(json);
          }
    ...
    _loadPage = function(params) {
      var _tileId, _userProfile, cards, dictionary, lang;
