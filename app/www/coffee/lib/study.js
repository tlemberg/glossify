...
(function() {
  define(['utils', 'stack', 'storage', 'nav', 'deck', 'css', 'pageview'], function(utils, stack, storage, nav, deck, css, pageview) {
    var CARD_ASPECT, MAX_BUTTON_AREA_WIDTH, MAX_CARD_WIDTH, _card, _deck, _getTxSummary, _hideFlipButton, _isFlipped, _loadPage, _nav, _refreshContentPane, _refreshPage, _registerEvents, _resetCard, _setBottomText, _setHeaderCss, _setProgressCounter, _setStudyFooterCss, _setStudyFooterHtml, _setTopText, _showFlipButton;
    _nav = void 0;
    _isFlipped = false;
    _card = void 0;
    _deck = void 0;
    ...
    _loadPage = function(template) {
      var box, cards, dictionary, interval, lang, maxIndex, minIndex, section, templateArgs, userProfile;
    ...
    _registerEvents = function() {
      ...
      return $('.study-page .back-btn').click(function(event) {
