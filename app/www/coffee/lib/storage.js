...
(function() {
  define(['utils'], function(utils) {
    var ACCESS_TOKEN_KEY, ACCOUNT_CONFIRMED_KEY, BOX_KEY, DICTIONARY_KEY, LANGUAGE_KEY, PAGE_KEY, SECTION_KEY, USER_PROFILE_KEY, _getAccessToken, _getAccountConfirmed, _getBox, _getDictionary, _getLanguage, _getLocalStorageItem, _getPage, _getSection, _getUserProfile, _isLoggedIn, _logout, _removeLocalStorageItem, _setAccessToken, _setAccountConfirmed, _setBox, _setDictionary, _setLanguage, _setLocalStorageItem, _setPage, _setSection, _setUserProfile;
    PAGE_KEY = 'page';
