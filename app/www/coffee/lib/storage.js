...
(function() {
  define(['utils'], function(utils) {
    var ACCESS_TOKEN_KEY, ACCOUNT_CONFIRMED_KEY, BOX_KEY, DICTIONARY_KEY, LANGUAGE_KEY, PAGE_KEY, PROGRESS_KEY, PROGRESS_UPDATES_KEY, SECTION_KEY, STUDY_MODE_KEY, STUDY_ORDER_KEY, USER_PROFILE_KEY, _addProgressUpdate, _clearProgressUpdates, _getAccessToken, _getAccountConfirmed, _getBox, _getDictionary, _getLanguage, _getLocalStorageItem, _getPage, _getPlan, _getProgress, _getProgressUpdates, _getSection, _getStudyMode, _getStudyOrder, _getUserProfile, _isLoggedIn, _logout, _removeDictionary, _removeLocalStorageItem, _removePlan, _removeProgress, _setAccessToken, _setAccountConfirmed, _setBox, _setDictionary, _setLanguage, _setLocalStorageItem, _setPage, _setPlan, _setProgress, _setProgressObject, _setSection, _setStudyMode, _setStudyOrder, _setUserProfile;
    PAGE_KEY = 'page';
