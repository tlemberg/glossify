...
(function() {
  define(['utils', 'storage', 'nav', 'strings', 'config', 'stack'], function(utils, storage, nav, strings, config, stack) {
    var URL_BASE, _addExcerpt, _addLanguage, _apiUrl, _authenticateUser, _createUser, _ensureDictionary, _ensureExcerptDictionary, _ensurePlan, _fetchDictionary, _getPlan, _getProgress, _nav, _requestAccess, _updateProgress, _updateUserProfile;
    ...
    _addExcerpt = function(excerpt, handler) {
      var authenticated, data;
    ...
    return {
      ...
      addExcerpt: function(excerpt, handler) {
        _nav = require("nav");
        return _addExcerpt(excerpt, handler);
      },
