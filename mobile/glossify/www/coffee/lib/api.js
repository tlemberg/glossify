...
(function() {
  define(['utils', 'storage', 'nav', 'strings', 'config'], function(utils, storage, nav, strings, config) {
    var URL_BASE, _addLanguage, _apiUrl, _authenticateUser, _createUser, _ensureDictionary, _ensurePlan, _fetchDictionary, _getPlan, _getProgress, _nav, _requestAccess, _updateProgress, _updateUserProfile;
